...
# call_package = 'com.vodafone.messaging'
# #message_activity = 'com.witsoftware.wmc.TabNavActivity'
# call_activity = 'com.vodafone.callplus.phone.activity.MainActivity'
...
class Call(Common):
    ...
    def __init__(self, device, log_name="CALL"):
    ...
    def end_call(self):
        ...
        endBtn = self._device(resourceId="com.google.android.dialer:id/incall_end_call")
        if endBtn.exists:
            endBtn.click.wait()
    ...
    def callFromContacts(self, _index=0):
        ...
        if self._device(resourceId="com.tct.dialer:id/cliv_name_textview", instance=2).exists:
            ...
            return False
        dialIcon = self._device(resourceId="com.google.android.contacts:id/verb_call")
        dialIcon.click.wait()
    ...
    def callFromDifMode(self):
        ...
        try:           
            ...
            if self._device(resourceId="com.google.android.dialer:id/search_card").exists:
    ...
    def switchBackAndInvokeFromRecent(self):
        ...
        if self._device(resourceId="com.tcl.android.launcher:id/snapshot").exists:
            self._device(resourceId="com.tcl.android.launcher:id/snapshot").click()
            return True       
        self._device.delay(2)  
        self.backToHome()
        return False
    ...
    def enterDetailsAndCall(self):
        ...
        if self._device(text="Contacts").exists:
            self._device(text="Contacts").click()
            self._device.delay(1)  
        # lstItem=self._device(resourceId="android:id/list")
        if self._device(resourceId="com.google.android.dialer:id/contact_name",instance=2).exists:
            self._device (resourceId="com.google.android.dialer:id/contact_name", instance=2).click()
    ...
    def inputNumber(self,number="10010"):
        ...
        for i in numlist:
            if i=='0':
                self._device(resourceId="com.google.android.dialer:id/zero").click()
            if i=='1':
                self._device(resourceId="com.google.android.dialer:id/one").click()
            if i=='2':
                self._device(resourceId="com.google.android.dialer:id/two").click()
            if i=='3':
                self._device(resourceId="com.google.android.dialer:id/three").click()
            if i=='4':
                self._device(resourceId="com.google.android.dialer:id/four").click()
            if i=='5':
                self._device(resourceId="com.google.android.dialer:id/five").click()
            if i=='6':
                self._device(resourceId="com.google.android.dialer:id/six").click()
            if i=='7':
                self._device(resourceId="com.google.android.dialer:id/seven").click()
            if i=='8':
                self._device(resourceId="com.google.android.dialer:id/eight").click()
            if i=='9':
                self._device(resourceId="com.google.android.dialer:id/nine").click()
            self._device.delay(1)
