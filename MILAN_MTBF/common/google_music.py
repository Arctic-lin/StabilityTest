...
#3/15 11:05,Change Class name Music to Google_Music
class google_Music(Common):
    ...
    def setup(self):
        ...
        if self.device(resourceId="com.google.android.music:id/play_pause_header").wait.exists(timeout=3000):
            self.device(resourceId="com.google.android.music:id/play_pause_header").click()
            self.device.delay(1)
    ...
    def play_music(self):
        ...
        if self.device(text="Shuffle all").exists:
            ...
            self.device(text="Shuffle all").click()  # double confirm shuffle all clicked
            self.device.delay(2)
        music = self.device(resourceId="com.google.android.music:id/trackname").get_text()
